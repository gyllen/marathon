 ...
 */
  ...
  def greater[A](x: A)(implicit Ord: Ordering[A], reads: Reads[A]): Reads[A] =
...
trait AppDefinitionFormats {
  ...
  implicit lazy val AppDefinitionReads: Reads[AppDefinition] = {
    ...
    (
      ...
      (__ \ "cpus").readNullable[JDouble](greater(0.0)).withDefault(DefaultCpus) ~
  ...
  implicit lazy val AppUpdateReads: Reads[AppUpdate] = {
    ...
    (
      ...
      (__ \ "cpus").readNullable[JDouble](greater(0.0)) ~
